...
export default function PortfolioBentoBox({ colorMode }) {
	...
	return (
		<div className={`${textColor} p-4 md:p-8`}>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-7xl mx-auto mb-20">
				...
				<div className={`${boxBgColor} rounded-lg p-6 col-span-2 lg:col-span-3 border ${borderColor}`}>
